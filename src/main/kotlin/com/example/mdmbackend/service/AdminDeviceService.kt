...
class AdminDeviceService(
    ...
    private fun com.example.mdmbackend.repository.DeviceRecord.toDeviceDetailResponse(): DeviceDetailResponse =
        DeviceDetailResponse(
            ...
            hasFcmToken = !fcmToken.isNullOrBlank(),
            fcmTokenUpdatedAtEpochMillis = fcmTokenUpdatedAt?.toEpochMilli(),
            lastWakeupAttemptAtEpochMillis = lastWakeupAttemptAt?.toEpochMilli(),
            lastWakeupReason = lastWakeupReason,
            lastWakeupResult = lastWakeupResult,
